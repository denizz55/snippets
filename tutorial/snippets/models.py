...
class Snippet(models.Model):
    ...
    ## Создаем новую модель Snippet и создаем миграцию через команды python manage.py makemigrations snippet
    ...
    def save(self, *args, **kwargs):  # new
        ...
        ##Используем библиотеку pygments для хранения выделенного HTML кода
